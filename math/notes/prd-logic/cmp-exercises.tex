...
\startexercises [title={\getvariable{document}{author}  \hfill  \getvariable{document}{course}: PS5  \hfill  2019-11-05}]
	...
	\startexercise [title={Enderton, 2.2.8}]
		Assume that \m{Σ} is a set of sentences such that for any sentence \m{τ}, either \m{Σ ⊨ τ} or \m{Σ ⊨ ¬τ}. Assume that \m{𝔄} is a model of \m{Σ}. Show that for any sentence \m{τ}, we have \m{\symentl[𝔄]{τ}} iff \m{Σ ⊨ τ}.
	\stopexercise
	...
	\startexercise [title={Enderton, 2.2.18}]
		...
		\startitemize [a]
			...
			\item  Show that if \m{\symentl[𝔄][s]{ψ}} and \m{ψ} is existential, then \m{\symentl[𝔅][s]{ψ}}. And if \m{\symentl[𝔅][s]{ϕ}} and \m{ϕ} is universal, then \m{\symentl[𝔅][s]{ϕ}}.
				\startsolution
