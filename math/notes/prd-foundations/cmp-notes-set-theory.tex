\startchapter [title={Exercises for 2019-09-10}]
	...
	\startproof
		...
		\bold{(\m{⊇})}
		Now, let \m{x ∈ ∅} be arbitrary. Again, there does not exist \m{x ∈ ∅}, rendering the statement vacuously true.
	\stopproof
	...
	\startproof
		...
		\bold{(\m{⊇})}
		Let \m{x ∈ B} be arbitrary. Then \m{x ∈ A} or \m{x ∈ B}, and so \m{x ∈ A ∪ B}.
	\stopproof
