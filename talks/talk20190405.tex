\environment ../environments/presentation
...
\startslide [title={Ito integral: \m{f ∈ L^2}}]
	\input knuth
\stopslide
...
\startslide [title={Ito integral: \m{f ∈ 𝓛^2}}]
...
\startslide [title={Ito isometry: \m{f ∈ L^2}}]
	bla bla bla
\stopslide

\startslide [title={Differential formula}]
	bla bla bla
\stopslide
