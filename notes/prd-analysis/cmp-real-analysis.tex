...
\startchapter [title={Differentiation}]
	...
	\startsection[title={Taylor series for multivariate functionals}]
		...
		\startformula
			T(a + x)  =  ∑_{n = 0}^∞  \frac{1}{n!} \inn[x, D_x \Big|_a]^n f ,
			\quad \text{ where }  \inn[x, D_x\Big|_a] = ∑_{j=1}^d x_j \frac{∂}{∂ x_j}\bigg|_a .
		\stopformula
