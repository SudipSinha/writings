...
% Logic
\def \symentl[#structure][#satisfaction]#arguments{⊨_{#structure} #arguments \ [#satisfaction]}
\def \nsymentl[#structure][#satisfaction]#arguments{⊭_{#structure} #arguments \ [#satisfaction]}
\def \synentl[#structure][#satisfaction]#arguments{⊢_{#structure} #arguments \ [#satisfaction]}
\def \nsynentl[#structure][#satisfaction]#arguments{⊬_{#structure} #arguments \ [#satisfaction]}
% \def \symentl[#arguments][#structure][#satisfaction]{⊢_{#structure} #arguments \ [#satisfaction]}
