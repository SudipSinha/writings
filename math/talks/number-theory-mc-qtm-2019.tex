...
\startslide [title={The Euclidean algorithm}]
	...
	Exercises: Use the Euclidean algorithm to find the \m{\gcd} of the following sets.
	\startitemize [i, joinedup]
...
\startslide [title={Tests of divisibility for \emph{decimal} numbers}]
	...
	\startitemize [m]
		...
		\item  \important{Test for \m{11}}: The number \m{n} must have its alternating sum of digits divisible by \m{11}.
