...
\startexercises [title={\getvariable{document}{author}  \hfill  \getvariable{document}{course}: HW2  \hfill  2019-09-24}]
	...
	\startexercise [title={Enderton, 1.2.6}]
		\startitemize [a, joinedup]
			...
			\item  Show that if \m{v_1} and \m{v_2} are truth assignments which agree on all the sentence symbols in the wff \m{α}, then \m{\bar{v}_1(α)} = \m{\bar{v}_2(α)}.
	...
	\startsolution
		...
		\startitemize [a]
			...
			\item  In this part, we use \m{v} to denote truth assignments and \quotation{\m{v} on a set} means \m{v} is defined on that set. Let \m{G} be the set of sentence symbols used in \m{Σ} and \m{τ}. Clearly, \m{G ⊆ S}.
	...
	\startexercise [title={Construction (10 × 2)}]
		\startitemize [i]
			...
			\item  Write down a construction sequence for \m{((¬((¬A_1) ∨ A_4)) ∧ ((A_1 → A_3) ↔ A_7))}.
				...
				\startsolution
					\m{\bngl[A_1, A_3, A_4, A_7, (¬A_1), ((¬A_1) ∨ A_4), (¬((¬A_1) ∨ A_4)), (A_1 → A_3), ((A_1 → A_3) ↔ A_7), ((¬((¬A_1) ∨ A_4)) ∧ ((A_1 → A_3) ↔ A_7))]}.
				\stopsolution
				
				\solution{\m{\bngl[A_1, A_3, A_4, A_7, (¬A_1), ((¬A_1) ∨ A_4), (¬((¬A_1) ∨ A_4)), (A_1 → A_3), ((A_1 → A_3) ↔ A_7), ((¬((¬A_1) ∨ A_4)) ∧ ((A_1 → A_3) ↔ A_7))]}.}
