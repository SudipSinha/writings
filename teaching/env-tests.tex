...
\startsetups[headertext]
  \startframed[frame=off, bottomframe=on, framecolor=\getvariable{document}{color-headings}, align=middle]
    {\tfc MATH 1550}\\
    \blank[big]
    {\tfb \sc Name: \color[white]{Print your name here in capitals}} \hfill {\tfa \getvariable{document}{date}}
    \blank[small]
  \stopframed
\stopsetups
