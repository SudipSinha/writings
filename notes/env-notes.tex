...
\definedescription[dscr][headstyle=bold, style=normal, align=flushleft, alternative=hanging, width=broad, margin=1em]
...
\def\d{\text{d}}
% \def\infinitelyoften{\text{i.o.}}
% \def\eventually{\text{ev}}
