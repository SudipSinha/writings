\startchapter [title={Combinatorics basics}]
	...
	\startsection [title={Enumerations}]
		...
		\startitemize [1, joinedup]
			...
			\item  Multiplication rule: if \m{E} and \m{F} are finite sets, then \m{|E × F| = |E| |F|}.

				Number of ways of constructing a 100 character string out of the 26 letters of the English alphabet.

			\item  Addition rule: if \m{E} and \m{F} are finite \emph{disjoint} sets, then \m{|E ⊔ F| = |E| + |F|}.
			...
			\item  Exercise: \cite[KT2016], Exercise 9
				...
				Solution: \m{(10 ⋅ 9 ⋅ 8) ⋅ \brnd[\binom{17}{3} ⋅ 5^3] ⋅ ((26 - 5) + (10 - 3))^{20 - 3 - 3}}.
